...
fun OnBoarding1Screen(viewModel: OnBoardingViewModel, navController: NavHostController) {
    Scaffold {
        Column(
            ...
            Image(
                painter = painterResource(viewModel.onboarding1!!.image),
                contentDescription = "",
            ...
            PagerIndicator(3, 0)
            Text(
                text = viewModel.onboarding1!!.title,
            ...
            Box(modifier = Modifier.width(263.dp), contentAlignment = Alignment.Center) {
                Text(
                    text = viewModel.onboarding1!!.text,
            ...
            Button(
                ...
                Text(
                    text = viewModel.onboarding1!!.text_button,
                    fontSize = 21.sp,
